...
import 'consumble_store.dart';

class InAppPurches extends StatefulWidget {
  const InAppPurches({Key? key}) : super(key: key);

  @override
  State<InAppPurches> createState() => _InAppPurchesState();
}
...
class _InAppPurchesState extends State<InAppPurches> {
